    ...
    <div className="p-6 bg-white rounded shadow">
      <div className="mb-4 flex justify-between items-center">
        <input
          ...
          className="border px-3 py-2 rounded shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
        />
      </div>
                ...
                <tr key={headerGroup.id}>
                  {headerGroup.headers.map((header) => (
                    <th
                      ...
                      className="px-4 py-3 cursor-pointer text-center font-medium text-gray-700 uppercase tracking-wider border-b"
                    >
